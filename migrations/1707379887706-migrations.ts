...
export class migrations1707379887706 implements MigrationInterface {
    name = 'migrations1707379887706'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "topic" ("id" BIGSERIAL NOT NULL, "index" integer NOT NULL, "topic" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "logId" bigint, CONSTRAINT "PK_33aa4ecb4e4f20aa0157ea7ef61" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "blockNumber" ("id" BIGSERIAL NOT NULL, "blockNumber" integer NOT NULL, "isNFTCompletedUpdate" boolean NOT NULL DEFAULT false, "isCompletedUpdate" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_d107ec7efea836f5b7537aefcd1" UNIQUE ("blockNumber"), CONSTRAINT "PK_6bbbc632faba12b9eef27ed63e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "decodedLog" ("id" BIGSERIAL NOT NULL, "action" character varying, "contractAddress" character varying, "tokenId" character varying, "from" character varying, "to" character varying, "ethValue" double precision, "unit" character varying, "value" double precision, "platform" character varying, "quantity" character varying, "minterAddress" character varying, "stage" character varying, "mintCount" integer, "timestamp" integer, "eventTime" TIMESTAMP, "gasUsed" character varying, "cumulativeGasUsed" character varying, "effectiveGasPrice" character varying, "gasPrice" character varying, "gasLimit" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "logId" bigint, "transactionId" bigint, "contractId" bigint, "nftId" bigint, CONSTRAINT "REL_eb122e51715ca224f918dc2b47" UNIQUE ("logId"), CONSTRAINT "PK_66659163606cf70161391d10d9f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_decodedlog_nft_action_timestamp" ON "decodedLog" ("nftId", "action", "timestamp") `);
        ...
        await queryRunner.query(`CREATE TABLE "log" ("id" BIGSERIAL NOT NULL, "transactionIndex" integer, "blockNumber" integer, "transactionHash" character varying, "address" character varying, "data" text, "logIndex" integer, "blockHash" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "decodedLogId" bigint, "transactionId" bigint, "contractId" bigint, "nftId" bigint, CONSTRAINT "REL_dfcbf4069ec1d3ab1be0b38102" UNIQUE ("decodedLogId"), CONSTRAINT "PK_350604cbdf991d5930d9e618fbd" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "attributeProperty" ("id" BIGSERIAL NOT NULL, "value" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "attributeId" bigint, CONSTRAINT "attributePropertyUnique" UNIQUE ("attributeId", "value"), CONSTRAINT "PK_30b7def1a023eb7efb59d450228" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_attributeproperty_attribute_value" ON "attributeProperty" ("attributeId", "value") `);
        await queryRunner.query(`CREATE TABLE "attributePropNFTMapping" ("id" BIGSERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "propertyId" bigint, "nftId" bigint, CONSTRAINT "attributePropNFTMappingUnique" UNIQUE ("propertyId", "nftId"), CONSTRAINT "PK_b633fac8238627bc1b23a9d1364" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "nft" ("id" BIGSERIAL NOT NULL, "tokenId" character varying, "tokenType" character varying, "title" character varying(1000), "description" text, "attributesRaw" text, "imageRaw" text, "imageRoute" character varying(1000), "imageAlchemyUrl" character varying(1000), "alchemyImageError" character varying(1000), "processingStatus" integer NOT NULL DEFAULT '1', "errorMessage" character varying(1000), "isUpdatedComplete" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractId" bigint, CONSTRAINT "uniqueIndex" UNIQUE ("contractId", "tokenId"), CONSTRAINT "PK_8f46897c58e23b0e7bf6c8e56b0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_nft_contract" ON "nft" ("contractId") `);
        await queryRunner.query(`CREATE TYPE "public"."trendCollection_timerange_enum" AS ENUM('1H', '6H', '12H', '24H', '7D')`);
        await queryRunner.query(`CREATE TABLE "trendCollection" ("id" BIGSERIAL NOT NULL, "floorPrice" double precision, "timeRange" "public"."trendCollection_timerange_enum" NOT NULL, "sales" integer, "salesDeviation" double precision, "salesDeviationPercent" double precision, "volume" double precision, "volumeDeviation" double precision, "volumeDeviationPercent" double precision, "averageValue" double precision, "priceDeviation" double precision, "priceDeviationPercent" double precision, "staticCreateAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractId" bigint, CONSTRAINT "PK_d2ee61d2620aa1addac85179168" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_trend_time_static" ON "trendCollection" ("timeRange", "staticCreateAt") `);
        await queryRunner.query(`CREATE TABLE "openseaCollection" ("id" BIGSERIAL NOT NULL, "totalSupply" integer, "count" integer, "bannerImageUrl" character varying(4000), "createdDate" TIMESTAMP, "description" text, "floorPrice" integer, "discordUrl" character varying, "externalUrl" character varying, "imageUrl" character varying(4000), "largeImageUrl" character varying, "mediumUsername" character varying, "name" character varying, "shortDescription" character varying, "slug" character varying, "telegramUrl" character varying, "twitterUsername" character varying, "instagramUsername" character varying, "wikiUrl" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractId" bigint, CONSTRAINT "REL_0d4d7bde35689019f1b5b337f7" UNIQUE ("contractId"), CONSTRAINT "PK_542b618a383d271ce1e337a075f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "benefit" ("id" BIGSERIAL NOT NULL, "benefit" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractDetailId" bigint, CONSTRAINT "PK_c024dccb30e6f4702adffe884d1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "loadmap" ("id" BIGSERIAL NOT NULL, "loadmap" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractDetailId" bigint, CONSTRAINT "PK_ed5516614ec6cf7d1633dc98451" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contractDetail" ("id" BIGSERIAL NOT NULL, "detailDescription" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractId" bigint, CONSTRAINT "REL_727ffa061c2fe8727c0971479f" UNIQUE ("contractId"), CONSTRAINT "PK_c8a2857b844d6d8cb9373b74f80" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contract" ("id" BIGSERIAL NOT NULL, "address" character varying, "name" character varying, "totalSupply" character varying, "imageUrl" character varying, "description" text, "externalUrl" character varying, "twitterUsername" character varying, "discordUrl" character varying, "symbol" character varying, "tokenType" character varying, "contractDeployer" character varying, "deployedBlockNumber" integer, "createdDate" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "openseaCollectionId" bigint, "contractDetailId" bigint, CONSTRAINT "UQ_4bbe5fb40812718baf74cc9a79e" UNIQUE ("address"), CONSTRAINT "REL_5b9ac2d9028faac901f4b351d4" UNIQUE ("openseaCollectionId"), CONSTRAINT "REL_df6f9c45ff54a962c9717a6f79" UNIQUE ("contractDetailId"), CONSTRAINT "PK_17c3a89f58a2997276084e706e8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_contract_openseaCollection" ON "contract" ("openseaCollectionId") `);
        await queryRunner.query(`CREATE TABLE "attribute" ("id" BIGSERIAL NOT NULL, "traitType" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractId" bigint, CONSTRAINT "attributeUnique" UNIQUE ("contractId", "traitType"), CONSTRAINT "PK_b13fb7c5c9e9dff62b60e0de729" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_attribute_contract" ON "attribute" ("contractId") `);
        await queryRunner.query(`CREATE TABLE "contractError" ("id" BIGSERIAL NOT NULL, "blockNumber" integer NOT NULL, "transactionHash" character varying NOT NULL, "address" character varying NOT NULL, "returnStringData" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fbaee01184d47ea6ed736fb78ed" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "kakaoAccessToken" ("id" BIGSERIAL NOT NULL, "accessToken" character varying, "expiresIn" integer, "scope" character varying, "refreshTokenExpiresIn" integer, "refreshToken" character varying, "tokenType" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bdf04e7c71c6f0e4da324d768a6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "decodeError" ("id" BIGSERIAL NOT NULL, "blockNumber" integer, "signature" character varying, "data" character varying, "log" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c533521ab03ca98b8eeffb5175b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "logError" ("id" BIGSERIAL NOT NULL, "blockNumber" integer NOT NULL, "transactionHash" character varying, "logId" integer, "errorMessage" character varying, "isCompletedCreate" boolean DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d846cbb696a0a315ed48511e15b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "signature" ("id" BIGSERIAL NOT NULL, "signatureId" integer NOT NULL, "textSignature" text NOT NULL, "hexSignature" character varying NOT NULL, "bytesSignature" character varying NOT NULL, "createdDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8e62734171afc1d7c9570be27fb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "openseaNFT" ("id" BIGSERIAL NOT NULL, "tokenId" character varying, "numSales" integer, "backgroundColor" character varying, "imageUrl" character varying, "imagePreviewUrl" character varying, "imageThumbnailUrl" character varying, "imageOriginalUrl" character varying, "animationUrl" character varying, "animationOriginalUrl" character varying, "name" character varying, "externalLink" character varying, "permalink" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b66545483112c4d539b76c6ac72" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "upcomingTwitter" ("id" BIGSERIAL NOT NULL, "followerCount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "upcomingContractId" bigint, CONSTRAINT "PK_9768fe879e32a5e0517d6c4a569" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "upcomingDiscord" ("id" BIGSERIAL NOT NULL, "joinCount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "upcomingContractId" bigint, CONSTRAINT "PK_6eb27edd27069e9199d0a66df02" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "upcomingContract" ("id" BIGSERIAL NOT NULL, "publishDate" TIMESTAMP, "name" character varying, "category" character varying, "totalSupply" bigint, "bannerImageUrl" character varying, "profileImageUrl" character varying, "description" text, "externalUrl" character varying, "twitterUsername" character varying, "discordUrl" character varying, "premintUrl" character varying, "preSalePrice" double precision, "publicSalePrice" double precision, "priceUnit" character varying, "tokenType" character varying DEFAULT 'ERC721', "isPublished" boolean NOT NULL DEFAULT false, "isRecommend" boolean NOT NULL DEFAULT false, "contractAddress" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9478f1b93c0c5b1f3b4358f49c1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."trendUpcomingCollection_timerange_enum" AS ENUM('1D', '3D', '7D', '14D')`);
        await queryRunner.query(`CREATE TABLE "trendUpcomingCollection" ("id" BIGSERIAL NOT NULL, "timeRange" "public"."trendUpcomingCollection_timerange_enum" NOT NULL, "twitterFollowerCount" integer, "twitterBeforeFollowerCount" integer, "twitterDeviation" double precision, "twitterDeviationPercent" double precision, "discordJoinCount" integer, "discordBeforeJoinCount" integer, "discordDeviation" double precision, "discordDeviationPercent" double precision, "staticCreateAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "upcomingContractId" bigint, CONSTRAINT "PK_34fdab3ba94019a230d0c3829f8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."trendCollections_timerange_enum" AS ENUM('1H', '6H', '12H', '24H')`);
        await queryRunner.query(`CREATE TABLE "trendCollections" ("id" BIGSERIAL NOT NULL, "floorPrice" double precision, "volume" double precision, "timeRange" "public"."trendCollections_timerange_enum" NOT NULL, "sales" integer, "staticCreateAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "contractId" bigint, CONSTRAINT "PK_4499e83aa0f7780d0b0736f397f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "userLog" ("id" BIGSERIAL NOT NULL, "userAgent" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5224381a9ff7ff1f947d4b9a021" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "wallet" ("id" BIGSERIAL NOT NULL, "username" character varying, "profileImgUrl" character varying, "address" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bec464dd8d54c39c54fd32e2334" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "walletContractConnection" ("id" BIGSERIAL NOT NULL, "walletId" bigint NOT NULL, "contractId" bigint NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f39c453492fe84fb37fe14c23ff" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "userLog"`);
        await queryRunner.query(`DROP TABLE "trendCollections"`);
        await queryRunner.query(`DROP TYPE "public"."trendCollections_timerange_enum"`);
        await queryRunner.query(`DROP TABLE "trendUpcomingCollection"`);
        await queryRunner.query(`DROP TYPE "public"."trendUpcomingCollection_timerange_enum"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_attribute_contract"`);
        await queryRunner.query(`DROP TABLE "attribute"`);
        await queryRunner.query(`DROP INDEX "public"."idx_contract_openseaCollection"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_trend_time_static"`);
        await queryRunner.query(`DROP TABLE "trendCollection"`);
        await queryRunner.query(`DROP TYPE "public"."trendCollection_timerange_enum"`);
        await queryRunner.query(`DROP INDEX "public"."idx_nft_contract"`);
        await queryRunner.query(`DROP TABLE "nft"`);
        await queryRunner.query(`DROP INDEX "public"."idx_attribute_mapping_nft"`);
        await queryRunner.query(`DROP INDEX "public"."idx_attribute_mapping_property"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_log_transaction_contract"`);
        await queryRunner.query(`DROP INDEX "public"."idx_log_decodedLog"`);
        await queryRunner.query(`DROP INDEX "public"."idx_log_contract"`);
        await queryRunner.query(`DROP INDEX "public"."idx_log_nft"`);
        await queryRunner.query(`DROP TABLE "log"`);
        await queryRunner.query(`DROP INDEX "public"."idx_transaction_blockNumber"`);
        await queryRunner.query(`DROP INDEX "public"."idx_transaction_eventTime"`);
        await queryRunner.query(`DROP INDEX "public"."idx_transaction_timestamp"`);
        await queryRunner.query(`DROP INDEX "public"."idx_transaction_hash"`);
        await queryRunner.query(`DROP INDEX "public"."idx_transaction_contract"`);
        await queryRunner.query(`DROP TABLE "transaction"`);
        await queryRunner.query(`DROP INDEX "public"."idx_decodedlog_contract_action_timestamp_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_decodedlog_nft_action_timestamp"`);
        await queryRunner.query(`DROP INDEX "public"."idx_decodedlog_contractaddress_timestamp"`);
        await queryRunner.query(`DROP INDEX "public"."idx_decodedlog_transaction"`);
        await queryRunner.query(`DROP INDEX "public"."idx_decodedlog_log"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_topic_log_topic_index"`);
        await queryRunner.query(`DROP INDEX "public"."idx_topic_log"`);
