...
const trandCollectionExample: any = {
  id: 1,
...
export class TrendCollections {
  ...
  static example(): TrendCollections {
    const instance: any = new TrendCollections();
...
if (isNestJs) {
  ...
  propertyDecorators.forEach((decorator, index) => {
    decorator(TrendCollections.prototype, index.toString());
  });
}
